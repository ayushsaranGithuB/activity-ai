...
Example: { "insight": "You spent 30% more time on Exercise this month compared to last month." }
...
Suggest merges only if categories describe the same thing. Return JSON: { "merges": [ { "from": "<old>", "into": "<new>" } ] }
